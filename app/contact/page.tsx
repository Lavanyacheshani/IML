        ...
        <section className="relative bg-[url('/placeholder.svg?height=400&width=1200&text=Contact+Us')] bg-cover bg-center py-24">
          ...
          <div className="container relative z-20">
            <div className="mx-auto max-w-3xl text-center text-white">
              <h1 className="mb-4 text-4xl md:text-5xl font-extrabold drop-shadow-lg">Contact Us</h1>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">+94117040140 / +94768545962</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">info@imledu.lk</p>
                    </div>
                  </div>
              ...
              <div className="bg-gray-50 p-8 rounded-xl shadow-lg">
                ...
                <form className="space-y-6">
                  ...
                  <div>
                    ...
                    <Input id="subject" type="text" className="w-full" required />
                  </div>
                  ...
                  <div>
                    ...
                    <Textarea id="message" rows={5} className="w-full" required />
                  </div>
          ...
          <div className="container">
            <div className="rounded-xl overflow-hidden shadow-xl h-[400px] md:h-[500px]">
              <iframe
                ...
                allowFullScreen
                loading="lazy"
                title="IML Business School Location"
              ></iframe>
            </div>
          </div>
        </section>
